...
- Pydantic schemas (`schemas/`) are the API contract only — they are never reused as the internal working data of the service layer, and never leak into the database layer.
